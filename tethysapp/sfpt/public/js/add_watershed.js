...
let ERFP_ADD_WATERSHED = (function() {
    ...
    *************************************************************************/
    ...
    finishReset = function(result, watershed_id) {
        if ("success" in result) {
            ...
            let xhr = ajax_update_database("delete",{watershed_id: watershed_id});
    ...
    *************************************************************************/
    ...
    $(function() {
        ...
        //initialize gizmo help blocks
        let help_html = '<p class="help-block hidden">No watershed name specified.</p>';
        ...
        $('#submit-add-watershed').click(function(){
            ...
            if(safe_to_submit.val && !m_uploading_data) {
                ...
                if($('#shp-upload-toggle').bootstrapSwitch('state')){
                    ...
                    xhr.done(function(return_data){
                        if ('success' in return_data) {
                            if('watershed_id' in return_data) {
                                let watershed_id  = return_data['watershed_id'];
                    ...
                    let xhr = ajax_update_database("submit", data);
